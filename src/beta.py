...
def initialize(context):
    ...
    run_daily(market_open_sell, time='15:00', reference_security='000001.XSHG')
    ...
    for user_stock_account in context.subportfolios:
        for key, stock in user_stock_account.long_positions.items():
            if stock.closeable_amount > 0:
                ...
                df = get_price(key, start_date=f'{date} 15:00:00', end_date=f'{date} 15:00:00', frequency='1m', fields=['pre_close','open','close', 'high_limit', 'money'], skip_paused=True, fq=None, panel=False)
